...
const { viewMode } = useViewMode('translate', 'card')
...
<template>
  <div class="translate-tasks-view">
    <div class="view-header">
      <div class="header-content">
        <div class="title-row">
          <h1 class="view-title">🌐 字幕翻译</h1>
          <span class="ws-status" :class="{ connected }">
            {{ connected ? '● 实时' : '○ 离线' }}
          </span>
        </div>
        <p class="view-description">将字幕翻译为目标语言</p>
      </div>
